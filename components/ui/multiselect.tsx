  ...
  return (
    ...
    >
          ...
          {selected.map((option) => {
            return (
              <div
                key={option.value}
                className={cn(
                  "animate-fadeIn bg-background text-foreground/50 hover:bg-background relative inline-flex h-7 cursor-default items-center rounded-md border ps-2 pe-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2",
                  badgeClassName
                )}
      ...
      <div className="relative">
        <div
          className={cn(
            " absolute top-2 z-10 w-full overflow-hidden rounded-md border",

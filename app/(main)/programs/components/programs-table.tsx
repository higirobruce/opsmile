...
const columns: ColumnDef<Item>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="font-medium">
                {moment(row.original.startDate).format('YYYY-MMM-DD')}
            </div>
        ),
        size: 180,
    },

    {
        ...
        cell: ({ row }) => (
            <div className="font-medium">
                {moment(row.original.endDate).format('YYYY-MMM-DD')}
            </div>
        ),
        size: 180,
    },
        ...
        cell: ({ row }) => (
            <div>
                <span className="text-sm leading-none">
                    {row.original.district && row.original.province ? (row.original.province?.name, row.original.district?.name) : 'Not set'}
                </span>{" "}
            </div>
        ),
        size: 180,

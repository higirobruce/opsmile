...
export default function Patients() {
  ...
  return (
    <>
      <SearchInput setTotalCount={(count) => setTotalCount(count)} pageSize={pageSize} currentPage={currentPage} setCurrentPage={setCurrentPage} setTotalPages={setTotalPages} setLoadingPatients={(loading) => setLoadingPatients(loading)} setPatientData={(data) => setPatientData(data)} />
      {/* {
